...
<header>
  ...
  <span style="color:var(--cream);font-weight:600;">Scout</span>
  <span class="badge">v0.1.0</span>
</header>
<main>
  <div class="hero">
    <h1>Scout</h1>
    <p>Dead link and SSL checker — crawl a domain, report broken links and expired certs on a schedule</p>
  </div>
  <div class="stats">
    <div class="stat">
  ...
  <div class="card">
    ...
    <div class="tier-box">
      <div class="tier">
        ...
        <div class="tier-desc">2 sites, weekly schedule</div>
        <div class="tier-price">$0/mo</div>
      </div>
      <div class="tier pro">
        <div class="tier-name">Pro</div>
        <div class="tier-desc">Unlimited sites, hourly schedule</div>
